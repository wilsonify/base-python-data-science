...
def main():
    ...
    logging.info(
        "%r",
        "bootstrap_statistic(close_to_100, median, 100): {}".format(
            bootstrap_statistic(close_to_100, median, 100)
        ),
    )
    logging.info(
        "%r",
        "bootstrap_statistic(far_from_100, median, 100): {}".format(
    ...
    logging.info("%r", "bootstrap standard errors {}".format(bootstrap_standard_errors))
