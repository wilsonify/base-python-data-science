...
def get_all_library_functions():
    ...
    # Populate module_mappings from grouped definitions
    ...
    WORKING_DATA_MODULE = wc['WORKING_DATA_MODULE']
    WORKING_E1004 = wc['WORKING_E1004']
    WORKING_E1006 = wc['WORKING_E1006']
    WORKING_E1007 = wc['WORKING_E1007']
    WORKING_E1008 = wc['WORKING_E1008']
    WORKING_E1009 = wc['WORKING_E1009']
    ...
    discovered = _discover_dsl_functions(module_mappings)
    module_mappings.update(discovered)
