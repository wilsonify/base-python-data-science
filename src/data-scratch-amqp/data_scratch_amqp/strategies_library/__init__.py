...
from data_scratch_amqp.strategies_library.echo import echo_strategy

# Try to import optional strategies that may have missing dependencies
try:
    from data_scratch_amqp.strategies_library.mysqrt import mysqrt_strategy
except ImportError:
    mysqrt_strategy = None

try:
    from data_scratch_amqp.strategies_library.mystrength import mystrength_strategy
except ImportError:
