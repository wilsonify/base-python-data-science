...
void Sqrt_input::validate() const
{
...
bool Sqrt_input::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool Sqrt_input::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "Sqrt_input" : pathPrefix;

        
    return success;
}

bool Sqrt_input::operator==(const Sqrt_input& rhs) const
{
    return
