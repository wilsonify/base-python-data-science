...
from dsl.c10_working_with_data.manipulation import rescale
...
def main():
    ...
    data = [
        ...
        (9.8, 79000, 1), ]
    data = tuples_to_lists(data)

    _x = get_x_from_data(data)
    _y = get_y_from_data(data)
...
def get_x_from_data(data):
    ...
    return [[1] + row[:2] for row in data]
