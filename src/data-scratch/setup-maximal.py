...
extensions = [
    Extension('data_science_from_scratch.*', ['data_science_from_scratch/**/*.py']),
]
...
class build_ext(build_ext_orig):
    ...
    def run(self):
        ...
        try:
            self.copy_file(Path('data_science_from_scratch/__init__.py'), root_dir, target_dir)
        except:
        ...
        try:
            self.copy_file(Path('data_science_from_scratch/__main__.py'), root_dir, target_dir)
        except:
